...
export default class GameOverScene2 extends Phaser.Scene {
    ...
    create(data) {
        ...
        const retry = this.add.image(400, 500, 'retry2').setScale(1.1);
        const stepback = this.add.image(1100, 500, 'stepback2').setScale(1.1);
